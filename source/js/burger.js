...
function closeHeaderMenu (event) {
  if (!event.target.hasAttribute('data-header-list') && !event.target.hasAttribute('data-header-category-title') && !event.target.hasAttribute('data-header-inner-list') && !event.target.hasAttribute('data-burger-button')) {
